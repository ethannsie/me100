...
AIN1 = Pin(X, mode=Pin.OUT)
AIN2 = Pin(XX, mode=Pin.OUT)
...
pwm_MotorA1 = PWM(AIN1, freq=10, duty=pwm_percent(XX))
pwm_MotorA2 = PWM(AIN2, freq=10, duty=pwm_percent(XX))
...
# Forward at 50% speed
pwm_MotorA1.duty(pwm_percent(XX))
pwm_MotorA2.duty(pwm_percent(XX))
#pwm_MotorB1.duty(pwm_percent(XX))
#pwm_MotorB2.duty(pwm_percent(XX))
sleep(2)

# Stop
pwm_MotorA1.duty(pwm_percent(100))
pwm_MotorA2.duty(pwm_percent(100))
# pwm_MotorB1.duty((100))
# pwm_MotorB2.duty((100))
sleep(2)

# Reverse at 50% speed
pwm_MotorA1.duty(pwm_percent(XX))
pwm_MotorA2.duty(pwm_percent(XX))
# pwm_MotorB1.duty(pwm_percent(X))
# pwm_MotorB2.duty(pwm_percent(XX))
sleep(2)
